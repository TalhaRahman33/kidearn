    ...
    <div className="login-container">
      ...
      <style jsx>{`
        ...
        .checkbox-container {
          display: flex;
          align-items: center;
          justify-content: space-between; /* 👈 pushes forgot link to the right */
          margin-top: 10px;
          margin-bottom: 20px;
          direction: rtl;
        }
        ...
        .forgot-link:hover {
          color: #f25334; /* 👈 brand accent on hover */
          text-decoration: underline;
        }

        /* Keep your existing global styles for .input-field, .submit-btn, etc. */
        /* They are assumed to be defined elsewhere or in global CSS */
      `}</style>
    </div>
  );
};
