    ...
    <>
     ...
     <Header />
      ...
      <section className="video-one">
        ...
        >
          <img src="/images/video-shape-1.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="/images/video-shape-2.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="/images/video-shape-3.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="/images/video-shape-4.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="/images/video-shape-5.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="/images/video-shape-6.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="/images/video-shape-7.png" alt="kidearn" />
        </div>
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-7">
              <div className="video-one__btn-shape">
                <div className="video-one__btn">
                  <img src="/images/video-bg-1.jpg" alt="kidearn" />
                  <a
      ...
      <section className="program-one">
        ...
        >
          <img src="/images/program-bg-shape.png" alt="kidearn" />
        </div>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              ...
              >
                ...
                <div className="program-one__item__image">
                  <img src="/images/program-1-1.jpg" alt="Toddler" />
                </div>
            ...
            <div className="col-lg-3 col-md-6">
              ...
              >
                ...
                <div className="program-one__item__bg"></div>
                <div className="program-one__item__image">
                  <img src="/images/program-1-2.jpg" alt="Preschool" />
                </div>
                <div className="program-one__item__content">
                  <h3 className="program-one__item__title">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              >
                ...
                <div className="program-one__item__bg"></div>
                <div className="program-one__item__image">
                  <img src="/images/program-1-3.jpg" alt="Kindergarten" />
                </div>
                <div className="program-one__item__content">
                  <h3 className="program-one__item__title">
            ...
            <div className="col-lg-3 col-md-6">
              ...
              >
                ...
                <div className="program-one__item__bg"></div>
                <div className="program-one__item__image">
                  <img src="/images/program-1-4.jpg" alt="School Age" />
                </div>
                <div className="program-one__item__content">
                  <h3 className="program-one__item__title">
                    <a href="programs-d-school.html">School Age</a>
                  </h3>
                  <div className="program-one__item__age">(5-6 years)</div>
                  <p className="program-one__item__text">
                    Lorem ipsum dolor sit amet consectetur. Convallis
                  </p>
                  <a
                    className="program-one__item__rm"
                    href="programs-d-school.html"
                  >
                    <span className="icon-right-arrow"></span>
                  </a>
                </div>
          ...
          >
            <div className="item">
              ...
              "scale": 1
                ...
                >
                  <img src="images/team-1-1.jpg" alt="Jane cooper" />
                </div>
      ...
      <section className="mail-one">
        ...
        <div className="container">
          <div className="mail-one__area">
            ...
            >
              <img src="images/mail-shape-3.png" alt="kidearn" />
            </div>
          </div>
        </div>
        {/* /.container */}
      ...
      <section className="blog-three">
        ...
        >
          <img src="images/blog-3-shape-1.png" alt="kidearn" />
        </div>
        <div
        ...
        >
          <img src="images/blog-3-shape-2.png" alt="kidearn" />
        </div>
        <div className="container">
          <div className="sec-title text-center">
